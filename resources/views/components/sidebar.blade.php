...
<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
    ...
    <nav class="flex-1 space-y-1 overflow-y-auto">
        ...
        @if($user->role === 'admin')
            ...
            @php
                $userMenuOpen =
                    request()->is('admin/KeluhanMasuk*') ||
                    request()->is('admin/daftarPenanganan*');
            @endphp
            ...
            <div x-data="{ open: {{ $userMenuOpen ? 'true' : 'false' }} }" class="space-y-1">
                ...
                <div x-show="open" x-collapse class="ml-10 space-y-1">
                    ...
                    <a href="/admin/KeluhanMasuk"
                    class="flex items-center gap-2 px-3 py-2 rounded-lg text-sm
                    {{ activeMenu('admin/KeluhanMasuk', $currentPath) }}">
                        <span>Karyawan</span>
                    </a>

                    <a href="/admin/daftarPenanganan"
                    class="flex items-center gap-2 px-3 py-2 rounded-lg text-sm
                    {{ activeMenu('admin/daftarPenanganan', $currentPath) }}">
                        <span>daftarPenanganan</span>
                    </a>
        ...
        @elseif($user->role === 'tenant_relation')
            ...
            @php
                $userMenuOpen =
                    request()->is('tenantrelation/keluhan/keluhanMasuk*') ||
                    request()->is('tenantrelation/keluhan/daftarPenanganan*');
            @endphp
            ...
            <div x-data="{ open: {{ $userMenuOpen ? 'true' : 'false' }} }" class="space-y-1">
                ...
                <div x-show="open" x-collapse class="ml-10 space-y-1">
                    ...
                    <a href="/tenantrelation/keluhan/KeluhanMasuk"
                    class="flex items-center gap-2 px-3 py-2 rounded-lg text-sm
                    {{ activeMenu('tenantrelation/keluhan/KeluhanMasuk', $currentPath) }}">
                        <span>Keluhan Masuk</span>
                    </a>

                    <a href="/tenantrelation/keluhan/daftarPenanganan"
                    class="flex items-center gap-2 px-3 py-2 rounded-lg text-sm
                    {{ activeMenu('tenantrelation/keluhan/daftarPenanganan', $currentPath) }}">
                        <span>Daftar Penanganan Keluhan</span>
                    </a>
